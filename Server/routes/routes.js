...
router.get('/universities/:id', verifyToken, getUniversityById);
router.post('/universities', verifyToken, createUniversity);
router.post('/universities/bulk-upload', verifyToken, bulkUploadUniversities);
...
router.post('/colleges/bulk-upload', verifyToken, bulkUploadColleges);
...
router.post('/master-subjects/bulk-upload', verifyToken, bulkUploadMasterSubjects);
...
router.post('/master-departments/bulk-upload', verifyToken, bulkUploadDepartments);
...
router.post('/student/marks-discrepancy', verifyToken, submitMarksDiscrepancy);
router.get('/student/marks-discrepancies', verifyToken, getStudentDiscrepancies);
router.get('/student/internal-exam-attendance', verifyToken, getStudentInternalExamAttendance);
router.get('/college-admin/internal-exam-attendance', verifyToken, getAdminInternalExamAttendance);
router.get('/faculty/internal-exam-attendance', verifyToken, getFacultyInternalExamAttendance);
/**
 * @swagger
