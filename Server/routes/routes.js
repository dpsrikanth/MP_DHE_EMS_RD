...
router.post('/master-programs/bulk-upload', verifyToken, bulkUploadPrograms);
...
router.get('/college-admin/seat-allocation-window', verifyToken, getSeatAllocationWindow);
