    ...
    <div className="p-6 bg-slate-50 min-h-screen">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
            <LayoutDashboard className="text-blue-600" /> Institution Performance Report
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {loading ? (
          ...
          return (
            <div key={index} className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col sm:flex-row gap-8 items-center group hover:border-blue-200 transition-colors">
              <div className="relative size-32 shrink-0">
                <svg className="size-full" viewBox="0 0 36 36">
                  ...
                  />
                  <path
                    className={`${passRate >= 75 ? 'text-emerald-500' : 'text-blue-500'} stroke-current`}
                    strokeWidth="4"
              ...
              <div className="flex-1 w-full space-y-4">
                ...
                <div className="pt-2">
                  <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div 
                      className={`h-full transition-all duration-1000 ${passRate >= 75 ? 'bg-emerald-500' : 'bg-blue-500'}`}
