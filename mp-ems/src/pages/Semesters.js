...
const Semesters = () => {
  ...
  // Removed handleAdd in favor of route-based Form page

  // Removed handleUpdate in favor of route-based Form page
    ...
    <div className="space-y-4">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button 
                          ...
                          title={authUtils.isSuperAdmin() ? "Remove Semester" : "Un-assign Semester"}
                        >
                          <MdDelete size={20} />
                        </button>
                      </div>
      ...
      {showAssignModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm animate-in fade-in" onClick={() => setShowAssignModal(false)} />
                ...
                <Select
                  ...
                  styles={{
                    control: (base, state) => ({
                      ...
                      boxShadow: 'none',
                      '&:hover': { borderColor: state.isFocused ? '#6366f1' : '#f1f5f9' }
                    })
                  }}
                />
