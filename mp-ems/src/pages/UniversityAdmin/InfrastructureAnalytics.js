      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        <div>
          <h1 className="text-2xl font-black text-slate-800 flex items-center gap-3">
            <Building2 className="text-indigo-600" size={32} /> Infrastructure Analytics
          </h1>
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-600/10 outline-none w-full font-medium transition-all"
              value={searchTerm}
              ...
              <div className="space-y-4">
                    ...
                    <div className="space-y-1.5 p-2 bg-slate-50/50 rounded-xl border border-slate-200/60">
                      ...
                      {item.approved_halls_details.length > 3 && (
                        <button
                          ...
                          className="w-full py-1.5 text-[12px] font-black text-indigo-600 hover:text-indigo-700  tracking-widest transition-colors flex items-center justify-center gap-1.5"
                        >
                          {expandedIds[item.id] ? (
                ...
                <div className="pt-2">
                  <div className="flex justify-between text-[13px] mb-1">
                    ...
                    <span className={isDeficit ? 'text-rose-600 font-bold' : 'text-indigo-600 font-bold'}>
                      {occupancy}%
                    </span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className={`h-full transition-all duration-500 rounded-full ${isDeficit ? 'bg-rose-500' : 'bg-indigo-600'}`}
